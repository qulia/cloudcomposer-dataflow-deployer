...
def trigger_dag(data, context=None):
    ...
    client_id = os.getenv("CLOUD_COMPOSER_CLIENT_ID")
    # This should be part of your webserver's URL:
    # {tenant-project-id}.appspot.com
    webserver_id = os.getenv("CLOUD_COMPOSER_WEBSERVER_ID")
    ...
    make_iap_request(
        webserver_url, client_id, method='POST', json={"conf": json.loads(contents), "replace_microseconds": 'false'})
